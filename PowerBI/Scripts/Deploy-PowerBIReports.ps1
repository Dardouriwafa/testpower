param(
	...
	[string] $PowerBIDirectory = "C:\src\PowerBI_CICD\PowerBI\Report",
	...
	[string] $ReportsToDeploy = '[
        {"Workspace":"PowerBI_CICD_Dev","Folder":"PowerBI_CICD","ReportName":"Report1"},
        {"Workspace":"PowerBI_CICD_Dev","Folder":"PowerBI_CICD","ReportName":"Report2"}
    ]',
